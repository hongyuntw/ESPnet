...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    # rm -f -r data/train data/test data/train_tmp data/test_tmp
    # mkdir data/train data/test
    # rm -f data/train_PTS/utt2dur data/train_PTS/utt2num_frames data/train_PTS/spk2utt
    # rm -f data/test_PTS/utt2dur data/test_PTS/utt2num_frames data/test_PTS/spk2utt
    # # Generate the fbank features; by default 80-dimensional fbanks with pitch on each frame
    # utils/utt2spk_to_spk2utt.pl data/train_PTS/utt2spk > data/train_PTS/spk2utt
    # utils/utt2spk_to_spk2utt.pl data/test_PTS/utt2spk > data/test_PTS/spk2utt


    # for x in test_PTS train_PTS train_FSW test_FSW final_test; do
    #     steps/make_fbank_pitch.sh --cmd "$train_cmd" --nj 8 --write_utt2num_frames true \
    #         --write_utt2dur true data/${x} exp/make_fbank/${x} ${fbankdir}
    #     utils/fix_data_dir.sh data/${x}
    # done
    rm -rf data/train_tmp data/test_tmp data/test data/train
    utils/combine_data.sh data/train_tmp data/train_PTS data/train_FSW
    utils/combine_data.sh data/test_tmp data/test_PTS data/test_FSW

    remove_longshortdata.sh --maxframes 3000 --maxchars 400  data/test_tmp data/test
    remove_longshortdata.sh --maxframes 3000 --maxchars 400  data/train_tmp data/train
