...
# GrandChallenge=/home/nlp/ASR/GrandChallenge/
# python3 pre.py --root ${GrandChallenge} -o ./data
# exit 0
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    # remove_longshortdata.sh --maxframes 3000 --maxchars 400 data/test data/test_removed
    # remove_longshortdata.sh --maxframes 3000 --maxchars 400 data/dev data/dev_removed
    # remove_longshortdata.sh --maxframes 3000 --maxchars 400 data/train data/train_removed
    # exit 0
